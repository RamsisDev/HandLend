...
import {
  UserOutlined, LockOutlined, MailOutlined, TeamOutlined,
...
export default function CoordinatorLoginPage() {
  ...
  return (
    <div className={styles.wrapper} data-testid="coordinator-login-page">
      <Card className={styles.card} bordered={false}>
        {/* Logo / header */}
        <div className={styles.logo}>
          <Space direction="vertical" size={4}>
            <TeamOutlined style={{ fontSize: 40, color: '#2dd4bf' }} />
            <Title level={3} style={{ margin: 0, color: '#f1f5f9' }}>
              Coordinator Access
            </Title>
            <Text type="secondary" style={{ fontSize: 13 }}>
              Log in or create an account to manage operations
            </Text>
          </Space>
        </div>
        ...
        <div className={styles.footer}>
          <Paragraph type="secondary" style={{ fontSize: 12, margin: 0 }}>
            Demo accounts: rfernandez@logihumanitas.cl / coord2026
          </Paragraph>
        </div>
      </Card>
    </div>
